...
const DoctorCard = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 p-6 mb-4 group">
      <img
        src={image}
        alt={name}
      ...
      <p className="text-gray-600 mb-2 flex items-center">
        <FaUserMd className="inline mr-2 text-[#0284c7]" />
        {profession}
      </p>
      <p className="text-gray-600 mb-2 flex items-center">
        <FaPhone className="inline mr-2 text-[#0284c7]" />
        {contact}
      </p>
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-[#e0f2fe] min-h-screen">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-4xl font-bold text-[#0284c7]">Our Doctors</h2>
        <button
          onClick={() => setIsModalOpen(true)}
          className="bg-[#0284c7] hover:bg-[#0273a1] text-white font-bold py-2 px-6 rounded-full flex items-center shadow-md hover:shadow-lg transition-shadow duration-200"
          disabled={isLoading}
        >
